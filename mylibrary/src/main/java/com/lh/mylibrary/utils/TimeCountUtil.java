...
public class TimeCountUtil extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        String text = millisUntilFinished / 1000 + "s后可重发";
        btn.setText(text);//设置倒计时时间

        //设置按钮为灰色，这时是不能点击的
        btn.setBackgroundResource(R.drawable.btn_border_ce_44);
        btn.setTextColor(ContextCompat.getColor(mActivity.getBaseContext(), R.color.color_e));
    ...
    public void onFinish() {
        ...
        btn.setBackground(ContextCompat.getDrawable(mActivity.getBaseContext(), R.drawable.btn_border_ca_44));//还原背景色
        btn.setTextColor(ContextCompat.getColor(mActivity.getBaseContext(), R.color.color_a));
